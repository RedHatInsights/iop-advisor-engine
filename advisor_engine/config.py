...
ADVISOR_ENGINE_MAX_REQUEST_BODY_SIZE = os.environ.get('ADVISOR_ENGINE_MAX_REQUEST_BODY_SIZE', (1024 * 1024) * 50) # 50MB
ADVISOR_ENGINE_MAX_HEADER_FIELDS = os.environ.get('ADVISOR_ENGINE_MAX_HEADER_FIELDS', 50)
ADVISOR_ENGINE_MAX_HEADER_FIELD_SIZE = os.environ.get('ADVISOR_ENGINE_MAX_HEADER_FIELD_SIZE', 8192) # 8KB
ADVISOR_ENGINE_LIMIT_MAX_REQUESTS = os.environ.get('ADVISOR_ENGINE_LIMIT_MAX_REQUESTS', 1000)
ADVISOR_ENGINE_BACKLOG = os.environ.get('ADVISOR_ENGINE_BACKLOG', 10000)
ADVISOR_ENGINE_TIMEOUT_KEEP_ALIVE = os.environ.get('ADVISOR_ENGINE_TIMEOUT_KEEP_ALIVE', 10)
ADVISOR_ENGINE_LIMIT_CONCURRENCY = os.environ.get('ADVISOR_ENGINE_LIMIT_CONCURRENCY', 100)
ADVISOR_ENGINE_TIMEOUT_GRACEFUL_SHUTDOWN = os.environ.get('ADVISOR_ENGINE_TIMEOUT_GRACEFUL_SHUTDOWN', 5)
